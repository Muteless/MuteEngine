...
public class TextureRegion
{
    ...
    /// <summary>
    /// Gets or sets the rectangle bounds of this texture region within the source texture.
    /// </summary>
    ...
    /// <summary>
    /// Creates a new texture region with default parameters.
    /// </summary>
    public TextureRegion() : this(null, 0, 0, 0, 0) { }
    ...
    /// <param name="x">The x-coordinate of the upper-left corner of this texture region.</param>
    /// <param name="y">The y-coordinate of the upper-left corner of this texture region.</param>
