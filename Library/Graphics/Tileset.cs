...
public class Tileset
{
    ...
    public Tileset(TextureRegion textureRegion, int tileWidth, int tileHeight)
    {
        ...
        // Create the texture regions that make up each tile
        ...
        for (int i = 0; i < Count; i++)
        {
            ...
            _tiles[i] = new TextureRegion(textureRegion.Texture, textureRegion.Bounds.X + x, textureRegion.Bounds.Y + y, tileWidth, tileHeight);
        }
    }
