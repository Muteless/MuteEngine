...
public class GamePadInfo
{
    ...
    // METHODS
    /// <summary>
    /// Updates the state information about gamepad input.
    /// </summary>
    public void Update(GameTime gameTime)
    {
        ...
        if (_vibrationTimeRemaining > TimeSpan.Zero)
        {
            ...
            // If the remaining time is less than or equal to zero, stop vibration
    ...
    public bool IsButtonDown(Buttons button) { return CurrentState.IsButtonDown(button); }
    ...
    public bool IsButtonUp(Buttons button) { return CurrentState.IsButtonUp(button); }
    ...
    public bool WasButtonJustPressed(Buttons button) { return CurrentState.IsButtonDown(button) && PreviousState.IsButtonUp(button); }
    ...
    public bool WasButtonJustReleased(Buttons button) { return CurrentState.IsButtonUp(button) && PreviousState.IsButtonDown(button); }
